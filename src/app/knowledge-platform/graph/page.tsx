...
export default function Page(){return <><Navbar/><Container><main style={{padding:"72px 0 96px",display:"grid",gap:28}}><KnowledgePlatformStats/><KnowledgeGraphExplorer/><EntityResolution/></main></Container><Footer/></>}
