...
const rows = [["Project escrow wallet", "$240k funded", "Healthy"], ["Milestone 1", "Design approval required", "Ready"], ["Milestone 2", "Development completion", "Review"], ["Milestone 3", "Client acceptance pending", "Review"], ["Escrow release policy", "Dual approval enforced", "Active"]];
  ...
  return (
    <Card variant="elevated" style={{ padding: 34 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 24 }}>
        <div>
          <Badge variant="info">Escrow Ledger</Badge>
          <h2 style={{ color: brand.colors.navy, fontSize: brand.typography.heading.h3, fontWeight: brand.typography.weight.bold, marginTop: 18, marginBottom: 0 }}>Milestone funding and release control</h2>
        </div>
