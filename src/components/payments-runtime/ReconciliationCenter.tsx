...
const rows = [["Provider settlement", "Gateway settlement file", "Reconciled"], ["Bank statement", "Operating account match", "Reconciled"], ["Escrow ledger", "Project balance integrity", "Healthy"], ["Payout ledger", "Recipient settlement match", "Reconciled"], ["Unmatched entries", "4 require review", "Review"]];
  ...
  return (
    <Card variant="elevated" style={{ padding: 34 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 24 }}>
        <div>
          <Badge variant="info">Reconciliation</Badge>
          <h2 style={{ color: brand.colors.navy, fontSize: brand.typography.heading.h3, fontWeight: brand.typography.weight.bold, marginTop: 18, marginBottom: 0 }}>Ledger, provider, and bank matching</h2>
        </div>
