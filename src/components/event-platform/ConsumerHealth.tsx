...
const rows = [["CRM consumer", "Lag 120 ms", "Healthy"], ["Analytics consumer", "Lag 240 ms", "Healthy"], ["Notification consumer", "Lag 310 ms", "Active"], ["Workflow consumer", "Lag 85 ms", "Healthy"], ["Audit consumer", "Lag 42 ms", "Healthy"]];
  ...
  return (
    <Card variant="elevated" style={{ padding: 34 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 24 }}>
        <div>
          <Badge variant="info">Consumer Health</Badge>
          <h2 style={{ color: brand.colors.navy, fontSize: brand.typography.heading.h3, fontWeight: brand.typography.weight.bold, marginTop: 18, marginBottom: 0 }}>Throughput, lag, and availability</h2>
        </div>
