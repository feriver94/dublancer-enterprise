...
const rows = [["18 pending events", "Schema or dependency failures", "Review"], ["6 retryable", "Transient downstream errors", "Active"], ["4 blocked", "Policy failures", "Blocked"], ["8 awaiting operator", "Manual review", "Review"], ["DLQ retention", "30-day controlled retention", "Healthy"]];
  ...
  return (
    <Card variant="elevated" style={{ padding: 34 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 24 }}>
        <div>
          <Badge variant="info">Dead-Letter Queue</Badge>
          <h2 style={{ color: brand.colors.navy, fontSize: brand.typography.heading.h3, fontWeight: brand.typography.weight.bold, marginTop: 18, marginBottom: 0 }}>Failed delivery investigation</h2>
        </div>
