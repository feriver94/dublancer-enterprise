...
const rows = [["Answer correctness", "Grounded response accuracy", "Healthy"], ["Hallucination check", "Unsupported claim detection", "Active"], ["Tool-use eval", "Permission-safe tool calling", "Ready"], ["Cost eval", "Provider and route economics", "Healthy"], ["Regression suite", "Release quality gate", "Active"]];
  ...
  return (
    <Card variant="elevated" style={{ padding: 34 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 24 }}>
        <div>
          <Badge variant="info">AI Evals</Badge>
          <h2 style={{ color: brand.colors.navy, fontSize: brand.typography.heading.h3, fontWeight: brand.typography.weight.bold, marginTop: 18, marginBottom: 0 }}>Quality, safety, and regression testing</h2>
        </div>
