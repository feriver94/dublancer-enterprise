...
const rows = [["Ingestion", "Files, CRM, workspace, graph data", "Ready"], ["Chunking", "Semantic windows and metadata", "Healthy"], ["Embedding", "Multi-model embedding strategy", "Active"], ["Hybrid Retrieval", "Keyword plus vector search", "Active"], ["Grounded Answering", "Source-aware response generation", "Ready"]];
    ...
    <Card variant="elevated" style={{ padding: 34 }}>
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 24 }}>
        <div>
          ...
          <h2 style={{ color: brand.colors.navy, fontSize: brand.typography.heading.h3, fontWeight: brand.typography.weight.bold, marginTop: 18, marginBottom: 0 }}>Retrieval-augmented generation architecture</h2>
        </div>
